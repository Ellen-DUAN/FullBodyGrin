...
class UpcomingWorkouts extends React.Component {
    ...
    render () {
        ...
        if(this.state.workouts_list.length == 0) {
            card = <p>No Upcoming Workouts</p>
        } else if(this.state.workouts_list.length == 1) {
            const date = this.state.workouts_list[0]['completion_date']
            ...
            const date1 = this.state.workouts_list[0]['completion_date']
            const distance1 = this.state.workouts_list[0]['distance']
            const calories1 = this.state.workouts_list[0]['calories_burnt']
            const date2 = this.state.workouts_list[1]['completion_date']
